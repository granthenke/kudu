...
import static org.apache.kudu.hive.KuduStorageHandler.KUDU_TABLE_NAME_KEY;
...
public class KuduInputFormat extends InputFormat<NullWritable, KuduWritable>
  ...
  private List<KuduInputSplit> computeSplits(Configuration conf) throws IOException {
    KuduClient client = KuduHiveUtils.getKuduClient(conf);
    try {
      ...
      // TODO: Support more configurations similar to the Spark integration.
